...
import es.jrodg85.InmoGuancheCRM.rest.OfertaController;

@Configuration
@PropertySource({"classpath:config/rest.properties", "classpath:config/jackson.properties"})
@ComponentScan("es.jrodg85.InmoGuancheCRM")
public class ConfiguracionPorJava {
  ...
  RepresentationModelProcessor<RepositorySearchesResource> addSearchLinks(
    ...
    controllersRegistrados.put(OfertaConId.class, OfertaController.class);
